...
# PLOT MIT ABUNDANZ-BERÜCKSICHTIGUNG
# ICH GLAUE SOWEIT FERTIG
# SKALA NACH VORSCHLAG VALENTIN

# NEUE VERSION ERSTELLEN, WO DIE TRANSPARENZ UNABHÄNGIG VON GESAMTANZAHL
# -> ERMÖGLICHT VERGLEICH VERSCHIEDENER ÖKOGRAMME -> v4.5