...
power = 5 # what number is reasonable?
...
# experimental: instead of red point, a rectangle
# biased towards the center, either fix or remove
# Find the area with maximum overlap
# if max_overlap > 0:
#     # Get coordinates of the weighted center
#     highlight_x = x_weighted
#     highlight_y = y_weighted
    
#     # Draw a rectangle around it
#     highlight_size = 1  # Adjust as needed
...
# Add center legend entry -> alternative to below, if using the rectangle
# legend_elements.append(
...
#                markersize=10,
#                linestyle='none',
#                label='Gebiet mit dem stärksten\nPflanzenvorkommen')
# )
...
# PLOT OHNE ABUNDANZ-BERÜCKSICHTIGUNG
# ICH GLAUE SOWEIT FERTIG
# SKALA NACH VORSCHLAG VALENTIN
# FIXE TRANSPARENZ -> VERGLEICH ZWISCHEN VERSCHIEDENEN AUFNAHMEN